<!-- Fonts preloaded via CSS @import in index.css -->
<!doctype html>
<html lang="en">
  <head>
...
s1.async=true;
s1.src='https://embed.tawk.to/6a291080f0b5881c2ac3d654/1jqo6gui0';
s1.charset='UTF-8';
...
<!--End of Tawk.to Script-->
    ...
    />
    <meta name="author" content="Home Chef Recipes" />
    <link
      rel="icon"
      type="image/svg+xml"
    ...
    <meta property="og:title" content="Home Chef Recipes" />
    <meta
      property="og:description"
      content="Discover delicious, easy-to-follow recipes for every occasion."
    />
    <meta property="og:type" content="website" />
    <meta
      property="og:image"
      content="https://hercules.app/og/app/%VITE_HERCULES_WEBSITE_ID%.png"
    />
    ...
    <script type="module" crossorigin src="/assets/index-BJsdonUd.js"></script>
    <link rel="stylesheet" crossorigin href="/assets/index-BZKiKMkG.css" />
  </head>
  <body>
    <div id="root"></div>
  </body>
